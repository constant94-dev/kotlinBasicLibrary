...
android {
    namespace = "com.example.app_gpsmap"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.example.app_gpsmap"
        minSdk = 21
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    val googleMap = "18.1.0"
    val googleLocation = "21.0.1"
    ...
    // coil, 이미지 처리를 위한 라이브러리
    implementation("io.coil-kt:coil-compose:$coilVersion")

    // MapView, Google Map 사용을 위한 라이브러리
    implementation("com.google.android.gms:play-services-maps:$googleMap")

    // FusedLocationProviderClient, 위치 정보 활용을 위한 라이브러리
